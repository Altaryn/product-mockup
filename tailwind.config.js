...
export default {
  ...
  theme: {
    extend: {
      ...
      fontSize: {
        'display-lg': ['60px', { lineHeight: '1.05', fontWeight: '500' }],
        ...
        'button-cap': ['14px', { lineHeight: '1.14', letterSpacing: '0.2px', fontWeight: '700' }],
        'button-cap-light': ['14px', { lineHeight: '1.29', letterSpacing: '0.2px', fontWeight: '500' }],
        caption: ['14px', { lineHeight: '1.43', fontWeight: '400' }],
        'micro-cap': ['10px', { lineHeight: '1.8', letterSpacing: '0.25px', fontWeight: '600' }],
